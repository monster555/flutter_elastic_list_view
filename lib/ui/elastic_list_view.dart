...
import 'package:flutter_elastic_list_view/config/drag_scroll_behavior_configuration.dart';
import 'package:flutter_elastic_list_view/utils/elastic_list_view_utils.dart';
...
class ElasticListViewState extends State<ElasticListView>
  ...
  Widget build(BuildContext context) {
    final padding = widget.scrollDirection == Axis.vertical
        ? EdgeInsets.symmetric(
            vertical: (_elasticity - 1) * widget.elasticityFactor)
        : EdgeInsets.symmetric(
            horizontal: (_elasticity - 1) * widget.elasticityFactor);
